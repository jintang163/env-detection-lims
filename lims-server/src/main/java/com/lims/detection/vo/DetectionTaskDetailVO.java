...
@Data
@ApiModel("检测任务详情VO")
public class DetectionTaskDetailVO {
    ...
    @ApiModelProperty("状态流转日志列表")
    private List<TaskStatusLogVO> statusLogList;

    @ApiModelProperty("分配记录列表")
    private List<TaskAssignmentVO> assignmentList;

    @ApiModelProperty("设备使用记录列表")
    private List<EquipmentUsageVO> equipmentUsageList;
