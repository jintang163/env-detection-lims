...
public class ContractDetailVO {
    ...
    private List<ConContractChange> changeList;

    @ApiModelProperty("审批记录列表")
    private List<ConContractApproval> approvalList;

    @ApiModelProperty("履约记录列表")
    private List<ConContractPerformance> performanceList;
}
